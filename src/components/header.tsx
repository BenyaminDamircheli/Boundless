...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center w-full mx-auto pt-5 bg-white">
      ...
      <nav className="flex justify-end gap-x-3 items-center">
        <SignedOut>
          <SignInButton mode="modal">
            <button className="bg-indigo-600 text-black font-bold px-4 py-1 rounded hover:bg-indigo-500 transition-all mr-14 mt-4 text-lg">Log in</button>
          </SignInButton>
        </SignedOut>
        <SignedIn>
          <div className="mr-14">
