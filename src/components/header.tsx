...
import { Matrix } from "./ui/dotMatrix";
import { AnimatePresence } from "framer-motion";
import { ChevronDown, Cpu, FileQuestionIcon, GraduationCap, SquareArrowUpRight, Wifi } from "lucide-react";
      ...
      <div className="relative w-full h-[90px]">
        ...
        <div className="relative flex justify-between items-center w-full mx-auto pt-5 bg-transparent z-10">
          <div className="flex items-center ml-14">
            <Link href="/">
              <Image src="/Cogni.png" alt="Cogni" width={32} height={32} className="border-2 border-indigo-600 rounded p-1" />
            </Link>
            <h1 className="text-3xl font-bold ml-3 text-black">
              <Link href="/" className="text-black">Boundless</Link>
            </h1>
          </div>
                  ...
                  <DialogContent className="bg-white border-2 border-zinc-700">
                    ...
                    <DialogDescription>
                      <div className="text-[13px] flex items-center justify-center">
                        <p>A collection of features that we will add to Boundless Pro in the near future.</p>
                      </div>
                    </DialogDescription>
                    <div className="flex justify-center items-center mx-4 my-4">
                      <div className="grid gap-x-[65px] gap-y-10 grid-cols-2">
                        <div>
            ...
            <SignedIn>
              <div className="flex items-center gap-4">
                <Dialog>
                  ...
                  <DialogContent className="bg-white border-2 border-zinc-700">
                    {/* Dialog content for signed-in users (same as above) */}
                  </DialogContent>
                </Dialog>
